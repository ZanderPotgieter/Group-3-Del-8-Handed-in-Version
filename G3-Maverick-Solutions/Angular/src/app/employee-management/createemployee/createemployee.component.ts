...
export class CreateemployeeComponent implements OnInit {
 ...
 {
   this.api.postFile(Caption.value, this.fileToUpload, EmployeeID).subscribe(
     data => {
       console.log('done');
       Caption.value = null;
       Image.value = null;
 ...
 {
   this.api.postFile(Caption.value, this.fileToUpload, EmployeeID).subscribe( (res: any) =>
      {
       console.log(res);
       if(res.Error != null)
       {
